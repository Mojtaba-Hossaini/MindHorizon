...
namespace MindHorizon.ViewModels.Home
{
    ...
    {
        public HomePageViewModel(List<PostViewModel> post, List<PostViewModel> mostViewedPosts, List<PostViewModel> mostTalkPosts, List<PostViewModel> mostPopularPosts, List<VideoViewModel> videos)
        {
            Post = post;
